...
export default class ResponsibilityFormComponent extends Component {
  @service router;
  ...
  <template>
    <div class="responsibility-form">
      <h1>{{if @model.isNew "Add Responsibility" "Edit Responsibility"}}</h1>
      <p class="breadcrumb">
      ...
      <form {{on "submit" this.save}}>
        <label>
          ...
          <textarea
            ...
            placeholder="Led team of 5 engineers in developing microservices architecture"
            rows="3"
            required
          ></textarea>
        </label>
